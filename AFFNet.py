...
class SELayer(nn.Module):
    ...
    def __init__(self, channel_num, compress_rate):
        ...
        self.se = nn.Sequential(nn.Linear(channel_num, (channel_num) // compress_rate, bias=True), nn.ReLU(inplace=True),
                                nn.Linear((channel_num) // compress_rate, channel_num, bias=True), nn.Sigmoid())
...
class AFFNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.eyesMerge_2 = nn.Sequential(nn.ReLU(inplace=True), SELayer(64, 16))
...
if __name__ == '__main__':
    m = AFFNet()
    feature = {"left": torch.zeros(10, 1, 36, 60), "right": torch.zeros(10, 1, 36, 60)}
    feature = {
        "faceImg": torch.zeros(10, 3, 224, 224),
        "leftEyeImg": torch.zeros(10, 3, 112, 112),
        "rightEyeImg": torch.zeros(10, 3, 112, 112),
        "faceGridImg": torch.zeros(10, 12),
